...
The matrix $A$ is called the \emph{stiffness matrix}, which is \cite{TODORAYMOND} spd. It is also a sparse matrix, as the basis functions only `interact' with a small number of neighbours.
