...
We will provide thoughts for future work in \S10. All our code is open-source and available at \url{http://github.com/rvanvenetie/bspcg/releases/tag/v1.0}.

\section{Sequential CG}
In its most basic (sequential, non-preconditioned) form, CG can be written down as in Algorithm~\ref{alg:seqcg}. \cite[Alg.~4.8]{biss04}
